...
import com.teamnewton.treasurehunt.ui.maps.PermissionRationaleDialog
import java.util.Locale

private const val NO_OF_ADDRESSES = 1


/**using geocoder to get city name from long and latitude
 *
 */
...
fun Activity.OnPermissionDenied(
    ...
    val showMapUI = remember { mutableStateOf(false) }
    ...
    if (shouldShowRequestPermissionRationale(Manifest.permission.ACCESS_COARSE_LOCATION)) {
        ...
        if (isDialogShown.value) {
            PermissionRationaleDialog(
                ...
                activityPermissionResult = activityPermissionResult,
                showMapUI = showMapUI
            )
        }
    } else {
